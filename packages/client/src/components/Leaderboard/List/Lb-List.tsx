...
function LeaderboardList() {
  ...
  return (
    ...
    <div className='d-flex flex-row'>
      <p className='flex-2 text-end align-middle p-2 my-auto'>Сортировать по:</p>
      <Form.Select id="sortSelect" onChange={(e) => {setSortMode(Number(e.currentTarget.value))}} className='flex-1'>
