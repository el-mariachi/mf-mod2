...
function Lb_User({place, nickname, score, date, time, kills, sortedVal} : LeaderboardProps) {
    ...
    <>
      ...
      <Collapse in={open}>
        <div className="flex flex-row justify-content-between border border-1 border-dark rounded fs-5">
          ...
          <img src="../" className='rounded-circle flex-2 d-inline-block lb-avatar border border-2'>
          </img>
        </div>
      </Collapse>
    </>
